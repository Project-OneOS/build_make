...
""" % bcb_dev)
  ...
  device = target_info.GetBuildProp("ro.oneos.device")
...
""" % bcb_dev)
  ...
  prev_build_date = source_info.GetBuildProp("ro.build.date")
  build_date = target_info.GetBuildProp("ro.build.date")
...
def WriteIncrementalOTAPackage(target_zip, source_zip, output_file):
  ...
  package_download_url = "https://sourceforge.net/projects/caf-test/files/" + device
